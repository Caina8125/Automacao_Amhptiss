...
class Login:
    def __init__(self, janela,corTema):
        ...
        self.comboBoxSetor = customtkinter.CTkComboBox(self.tela,border_color="#274360",button_color="#274360", button_hover_color="White",dropdown_fg_color="#274360", dropdown_text_color="White",text_color="#274360",values=["Glosa","Faturamento","Financeiro","NotaFiscal"], width=180)
