...
class Recurso(PageElement):
    reapresentacao = (By.XPATH, '//*[@id="ctl00_SidebarMenu"]/li[6]')
    reapresentar_peg = (By.XPATH, '//*[@id="ctl00_SidebarMenu"]/li[6]/ul/li[1]')
    lista_excel = []
    ...
    botao_ok = (By.XPATH, '/html/body/div[1]/div/div/div[3]/button')
