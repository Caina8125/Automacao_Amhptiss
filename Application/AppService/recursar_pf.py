...
class Login(PageElement):
    prestador_pf = (By.XPATH, '//*[@id="tipoAcesso"]/option[5]')
        ...
        while count < 10:
            try:
                ...
                for planilha in lista_de_planilhas:
                    ...
                    time.sleep(2)        
                    self.driver.get("https://novowebplanpfdf.facilinformatica.com.br/GuiasTISS/Relatorios/ViewRelatorioServicos")
                    time.sleep(2)
                    try:
                        writer.close()
                    except:
...
def recursar_pf(user, password):
    try:
        global driver, url
        url = 'https://novowebplanpfdf.facilinformatica.com.br/GuiasTISS/Logon'
...
recursar_pf('lucas.paz', 'WheySesc2024*')