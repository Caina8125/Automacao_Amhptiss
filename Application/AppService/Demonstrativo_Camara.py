...
class DemonstrativoCamara(PageElement):
    ...
    def exe_caminho(self):
        ...
        time.sleep(2)
        DemonstrativoCamara(driver, url).Alert()
...
def demonstrativo_camara(user, password):
    ...
    try:
        ...
        DemonstrativoCamara(driver, url).exe_caminho()

        DemonstrativoCamara(driver, url).buscar_demonstrativo()
